document.addEventListener("DOMContentLoaded", () => {
    ...
    const matchedPairsContainer1 = document.getElementById("matchedPairs"); // Kontejner pro uhodnuté dvojice

    let attempts1 = 0;
    let attempts2 = 0;
    let pairs1 = 0;
    let pairs2 = 0;
    let currentPlayer = 1; // 1 nebo 2
    let firstCard = null;
    let secondCard = null;
    let lockBoard = false;
    ...
    function addToMatchedPairs() {
        ...
        matchedPairsContainer1.appendChild(matchedPair); // Přidání do kontejneru pro uhodnuté dvojice
    }
    ...
    document.getElementById("restart").addEventListener("click", () => {
        gameBoard.innerHTML = "";
        matchedPairsContainer1.innerHTML = ""; // Vyčistit hromádku uhodnutých dvojic
        attempts1 = 0;
        attempts2 = 0;
        pairs1 = 0;
        pairs2 = 0;
